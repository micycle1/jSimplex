...
public class TestAnimation extends JPanel {
	...
	public TestAnimation(String title) {
		m.addRange(0.5f, 1f, new Color(100, 100, 0), new Color(255, 255, 255), 0.7);
		m.addRange(0.3f, 0.5f, new Color(0, 100, 0), new Color(100, 100, 0), 0.8);
		m.addRange(0.15f, 0.3f, new Color(195, 195, 0), new Color(0, 100, 0), 0.8);
	...
	void addImage(float w, float z, int index) {
		float[] img = NoiseSurface.generate2dRawFrom4dOctaved(0, 0, z * 0.05f, w * 0.05f, xRes, yRes, zoom, 0.6, 4,
				true);
