...
public class ColorMapper {
	...
	public BufferedImage getBufferedImage(float[][] input) {
		...
		WritableRaster raster = imgB.getRaster();
	...
	/**
	 * Calculates a BufferedImage given a 1D array of noise data and the desired
	 * image's dimensions.
	 *
	 * @param input  Array of noise data.
	...
	public void addRange(float lowerLimit, float upperLimit, Color lowerColor, Color upperColor, double contrast) {
	...
	private static class ColorRange {
		...
		public ColorRange(float lowerLimit, float upperLimit, Color lowerColor, Color upperColor, double contrast) {
			super();
		...
		public Color getColor(float point) {
			float relativePosition = (point - lowerLimit) / (upperLimit - lowerLimit);
			...
			return new Color((int) (red + redRange * relativePosition), (int) (green + greenRange * relativePosition),
					(int) (blue + blueRange * relativePosition));
		}
	}
