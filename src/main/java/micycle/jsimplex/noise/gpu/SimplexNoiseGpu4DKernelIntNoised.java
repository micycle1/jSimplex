...
class SimplexNoiseGpu4DKernelIntNoised extends Kernel {
	...
	public void run() {
		...
		r[i] = noise(argsFloat[0] + argsFloat[4] * x, argsFloat[1] + argsFloat[4] * y, argsFloat[2] + argsFloat[4] * z,
	...
	public float noise(float x, float y, float z, float w) {
		...
		int gi1 = intNoise(ii + i1 + intNoise(jj + j1 + intNoise(kk + k1 + intNoise(ll + l1)))) % 32;
		int gi2 = intNoise(ii + i2 + intNoise(jj + j2 + intNoise(kk + k2 + intNoise(ll + l2)))) % 32;
		int gi3 = intNoise(ii + i3 + intNoise(jj + j3 + intNoise(kk + k3 + intNoise(ll + l3)))) % 32;
		int gi4 = intNoise(ii + 1 + intNoise(jj + 1 + intNoise(kk + 1 + intNoise(ll + 1)))) % 32;
